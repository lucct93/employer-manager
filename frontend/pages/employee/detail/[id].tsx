...
const HomePage = ({ data }: { data: EmployeeProps }) => {
	return (
		<>
			<HelmetCommon
				title='Employee Manager Detail'
				description='Description employee manager detail...'
				href={ROUTES.EMPLOYEE_DETAIL}
			/>
			<EmployeeCommon objectEmployee={data} type={EmployeeType.DETAIL} />
		</>
	);
};
